...
总代码行数:833,194行
代码文件大小:46.42MB
总文件大小:1.97GB(其中缓存量:1.68GB)
数据量:1,472,266行(237.4 MB)
...
*更新
1.更新[校庆栏目]UI框架基础件 本次更新主要同步了腾讯7.20发布的新WeUI设计(8.1)
*维护
1.腾讯下达[公众平台接口证书更换通知] 已对生产环境的根证书进行测试 BaltimoreCyberTrustRoot.crt[2025/05/13]可以使用(8.1)
2.设置QQ/微博头像CORS跨域CDN加速节点 节点部署于腾讯云(8.12)
*说明
1.[专属头像生成] 在腾讯微校方剑成版本上修改 添加新功能 修复img.js缺少导致无法生成图片保存的问题 修复头像服务器的跨域问题 添加jsonp数据缓存 授权费用已支付(8.11)
