...
switch($ch){
	case "delete":
	$id = $_POST['id'];
		$Z60Notice->DZ60Notice($id);
		echo '1';	
		break;
	case "isopen":
	$id = $_POST['id'];
	$isok = $_POST['isok'];
		$Z60Notice->IsokZ60Notice($id,$isok);
		echo '1';	
		break;
	case "edit":
...
break;
	...
	case "add":
		...
		$Z60Notice->SendZ60Notice($groupid,$title,$editor,$dcontent,$content,$istop);
		header("Location:/admin/Z60Notice/");
break;	}
?>>