...
if(dt[2] !== null && dt[2] !== undefined && dt[2] !== ''){
  ...
  $('html').addClass('loading');
    ...
    var editAlbum = (function() {
        ...
        $('.edit_this').click(function() {
            _this = $(this),
            pid = _this.parent().parent().parent().attr('data-id'),
            title = _this.parent().parent().parent().find('dt .pd5').html();
