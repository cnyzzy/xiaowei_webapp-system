...
//检查绑定
		...
		//登录
	$url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx2c645b02db7bbe5a&redirect_uri=".$arrInfo['url']."/cjhd/join/".$id."&response_type=code&scope=snsapi_userinfo&state=123#wechat_redirect";
...
$type=@$_SESSION['zid']['type'];
	...
	$ok=0; 
	    $sql = "SELECT  id FROM cjhd_on WHERE wxid ='{$_SESSION['wx']['openid']}' and sid='$id'";
