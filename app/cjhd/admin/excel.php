...
if($NOW=='all')
{$name="订票总表";
$sql = "SELECT * FROM hdxp_seat order by addtime desc";
}else{

$name="".$now."订票计表";
 $sql = "SELECT * FROM hdxp_seat where sid='".$NOW."' order by addtime desc";
}
