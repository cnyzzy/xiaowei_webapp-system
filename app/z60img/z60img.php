<?php
if(!is_dir(ZSystem.'/data/app/Z60Img') )mkdir(ZSystem.'/data/app/Z60Img');
...
exit;
	...
	$img="http://192.168.2.233/xw.jpg";
	$name=$_SESSION['zid']['name'];
	$openid=$_SESSION['wx']['openid'];
	if(!is_dir(ZSystem.'/data/app/Z60Img')&&!empty($number) )mkdir(ZSystem.'/data/app/Z60Img/'.$number);
