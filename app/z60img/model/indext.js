	...
	e["default"] = {
		...
		methods: {
			...
			makeImage: function() {
				var t = this;
				t.loading = "生成图片中...",
				this.avatar_url2 = 0 == this.avatar_url.indexOf("http") ? this.avatar_url.replace(/tva+[\w-]+\.sinaimg\.cn/, "timg.echo1.top") : this.avatar_url;
				...
				t.avatar_url = t.avatar_url.replace(/tv+[\w-]+\.sinaimg\.cn/, "timg.echo1.top");
