...
(function ($) {
    ...
    WcChart.prototype = {
        ...
        initData: function () {
            ...
            /* find out y-axis point of 8 thousand unit line */
            this.chartMeanLine = this.rectChartCenter.y + this.rectChartCenter.height
                - 8000 * this.rectChartCenter.height / yMaxUint;
            ...
            for (var i = 0; i < this.data.length; i++) {
                this.points[i] = {
                    ...
                    value: this.data[i],
                    text: i == 0 ?itrDay.getDate() : itrDay.getDate(),
        ...
        drawChart: function () {
            ...
            ctx.fillText("8K", this.rectChartCenter.x + this.rectChartCenter.width,
