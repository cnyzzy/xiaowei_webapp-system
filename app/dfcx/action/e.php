...
echojson(getjsondate($a,$_SESSION['dfidcode'],$params,$DB));
 IF(EMPTY($_SESSION['dfidcode'])&&$a=='9')
 {$ARRAR['ok']=9;
echojson($ARRAR);
 }
...
$post['xiaoqu']=$params[1];
	...
	$post['radio']='usedR';
$post['ImageButton1.x']=72;
$post['ImageButton1.y']=24;
	break;  
	default:
	$wb='';
	}
...
//验证
if(strlen($xfblh)==2&&strlen($xfbab)==1&&strlen($xfbfj)==3)
{$ARRAR['xfb']=$xfblh.$xfbab.$xfbfj;}else{
 $xfbroom='未知.';	
}
  break;  
case 22:
