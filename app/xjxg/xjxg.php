<?php
if(!is_dir(ZSystem.'/data/app/xjxg') )mkdir(ZSystem.'/data/app/xjxg');
...
$number=$_SESSION['zid']['number'];
	...
	if(!is_dir(ZSystem.'/data/app/xjxg/'.$openid) )mkdir(ZSystem.'/data/app/xjxg/'.$openid);
	if(!is_dir(ZSystem.'/data/app/xjxg/'.$openid.'/load') )mkdir(ZSystem.'/data/app/xjxg/'.$openid.'/load');
	if(!is_dir(ZSystem.'/data/app/xjxg/'.$openid.'/ok') )mkdir(ZSystem.'/data/app/xjxg/'.$openid.'/ok');
	if(!is_dir(ZSystem.'/data/app/xjxg/'.$openid.'/result') )mkdir(ZSystem.'/data/app/xjxg/'.$openid.'/result');
