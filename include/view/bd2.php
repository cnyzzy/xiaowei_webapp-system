...
ErrorMsg($Errormsg,'点击返回>>','/home/login/1');}else{
	...
	//ok
	header("Location:".$arrInfo['url']."/home/index/".mt_rand(1111,99999));
  break;
case 2://用户名或者密码错误
...
//教工
	empty($_POST['username']) ? $username = '' : $username = trim($_POST['username']);
	empty($_POST['number']) ? $number = '' : $number = trim($_POST['number']);
