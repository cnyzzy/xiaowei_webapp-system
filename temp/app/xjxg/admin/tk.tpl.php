...
function xx(id){
           ...
           window.open('<?php echo $arrInfo['url'];?>/admin/xjxg/option/'+id);
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 校纪校规测试管理-题库
                    </div>
                              ...
                              <table class="am-table am-table-striped am-table-hover table-main">
									...
									<?php foreach((array)$Array as $key=>$loopChild) {?>
                                        <tr>                                          
                                            ...
                                            <td><a href="<?php echo $arrInfo['url'];?>/admin/xjxg/option/<?php echo $loopChild['id'];?>"><?php echo $loopChild['title'];?></a></td>
										   <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
