                    ...
                    <div class="am-g">
                        <div class="am-u-sm-12">
						  <div class="am-btn-toolbar">
                               ...
                               <a href="<?php echo $arrInfo['url'];?>/admin/notice/add"> <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新建公告</button></a>
                                </div>
                            </div>
                            <form class="am-form">
