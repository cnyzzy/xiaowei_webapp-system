			...
			<div ID='show' class="mui-card mui-card2">
				<div class="mui-card-content">
					<div class="mui-card-content-inner">
						<?php if(!empty($postn)) { ?><?php echo $postn;?><?php } else { ?>未知<?php } ?>
					</div>
				</div>
			</div>		
			<?php if(!empty($WArrsy)) { ?>
			<?php foreach((array)$WArrsy as $key=>$loopChild) {?><div id="<?php echo $loopChild['id'];?>" class="mui-card">
				<div class="mui-card-header"><h3><?php echo $loopChild['room'];?></h3><?php echo $loopChild['xq'];?>-<?php echo $loopChild['name'];?></div>
				<div class="mui-card-content">
					<div class="mui-card-content-inner">
