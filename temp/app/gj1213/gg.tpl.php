...
<style>
    .content {
        ...
        width: 100%;
        bottom: 0;
        background-image: url('<?php echo $arrInfo['url'];?>/app/<?php echo $AppName;?>/model/praygg.png');
...
<script>
    $(function() {
        $('.pray-btn').click(function() {
				$.showLoading("正在点亮烛火");
            $.post('<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/dogg', {
                tag: 'pray'
            }, function(ret) {
                if (ret) {
							 setTimeout(function() {
			 $.hideLoading();
   location.href = '<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/gjgg';
        }, 800)	
        ...
        var share = {
            ...
            title: '铭记历史，珍爱和平！让我们为大屠杀遇难同胞点亮烛光，寄托哀思!',
            desc: '盐城师范学院公共管理学院国家公祭在线悼念'
        };
  wx.config({
