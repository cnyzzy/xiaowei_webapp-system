...
<style>
    .content {
        ...
        bottom: 0;
		right:0;
        background-image: url('<?php echo $arrInfo['url'];?>/app/<?php echo $AppName;?>/model/pray_bg3.gif');
    ...
    .pray-head {
        background-image: url('<?php echo $arrInfo['url'];?>/app/<?php echo $AppName;?>/model/pray-head.png');
        width: 100%;
        height: 4.5rem;
        background-repeat: no-repeat;
        background-size: auto 100%;
...
<script>
    $(function() {
        ...
        var share = {
            ...
            title: '80年，我们不曾忘记你们！为大屠杀遇难同胞点亮烛光!',
            desc: '我是第<?php echo $arr1['times'];?>位在线悼念者，让我们一起缅怀先烈寄托哀思!'
        };
  wx.config({
