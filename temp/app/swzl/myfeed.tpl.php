...
<body>
	...
	<div id="header" class="head">
		<div class="wrap">
			...
			<div class="title">
				<span class="title_d"><p>我的动态</p></span>
				<div class="clear"></div>
			</div>
  ...
  <div class="weui_panel_hd">对我的评论动态</div>
  <div class="weui_panel_bd">
    <?php if(!empty($Array)) { ?>		<?php foreach((array)$Array as $key=>$loopChild) {?><?php if(!empty($list[$loopChild['id']])) { ?>
    <a href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/detail/<?php echo $loopChild['sid'];?>#pl<?php echo $loopChild['id'];?>" class="weui_media_box weui_media_appmsg"> <div class="weui_media_box weui_media_text">
      <h4 class="weui_media_title"><?php echo $loopChild['name'];?>评论了：<?php echo $list[$loopChild['id']]['title'];?></h4>
      <p class="weui_media_desc"><?php echo $loopChild['reply'];?></p>
      <ul class="weui_media_info">
        <li class="weui_media_info_meta">评论时间</li>
        <li class="weui_media_info_meta"><?php echo(smartDate($loopChild['addtime'], 'y-m-d H:i:s'))?></li>
        <li class="weui_media_info_meta weui_media_info_meta_extra"><?php if(!empty($loopChild['editreply'])) { ?><font color="red">[已回复]</font><?php } ?></li>
      </ul>
    </div> </a><?php } ?>
   <?php }?>
             <?php } ?>
  ...
  <a class="weui_panel_ft" href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/my">查看我发布的失物招领</a>
</div>
	...
	<div id="us_panel2">
		<table width="100%" height="100%" cellspacing="0" border="0">
			<?php if(!empty($Array)&&$pagemax!=1) { ?><div class="button_sp_area" style="min-height:60px;max-height:70px; text-align: center;">
	<div <?php if($d>1&&$d<=$pagemax) { ?>onclick="urlpage('<?php echo $arrInfo['url'];?>/swzl/mygx/<?php echo $qpage;?>');" <?php } ?> class="weui_btn weui_btn_primary weui_btn_inline<?php if($d<=1) { ?> weui_btn_disabled<?php } ?> divhref" style="width:20%;">上页</div>
