...
<body>
	...
	<div id="header" class="head">
		<div class="wrap">
			...
			<div class="title">
				<span class="title_d"><p>我的评论</p></span>
				<div class="clear"></div>
			</div>
  ...
  <div class="weui_panel_bd">
    ...
    <a href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/detail/<?php echo $loopChild['sid'];?>#pl<?php echo $loopChild['id'];?>" class="weui_media_box weui_media_appmsg"> <div class="weui_media_box weui_media_text">
      <h4 class="weui_media_title">评论：<?php echo $list[$loopChild['id']]['title'];?></h4>
  ...
  <a class="weui_panel_ft" href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/my">查看我的动态</a>
</div>
