...
$.toast(data.content);
  ...
  $('html').addClass('loading');
            ...
            setTimeout(function() {
                window.location.href = zurl+"/swzl/wait/"+data.id;
            },
            400);
			 }
		   }, 
...
<body>
	...
	<div id="header" class="head">
		<div class="wrap">
			...
			<div class="title">
				<span class="title_d"><p>新建:失物招领</p></span>
				<div class="clear"></div>
			</div>
...
$("#styp").select({
  ...
  items: [
   ...
   onChange: function(d) {
    ...
    <div class="weui_cell_bd weui_cell_primary">
      <input class="weui_input" type="text" name="tname" id="tname" placeholder="请输入物品名称(如：手机)">
    </div>
  </div>
    ...
    <div class="weui_cell_bd weui_cell_primary">
<input class="weui_input" type="text" id='swher' name="swher"/>
<input type="text" id='swhere' name="swhere" style="display:none"/>
<script>
$("#swher").select({
  title: "请选择地点范围",
    items: [
...
,{ title: '==其他==', value: '6'}
  ...
  <div class="weui_cell"> <div class="weui_cell_hd"><label class="weui_label">详细地点</label></div>
    <div class="weui_cell_bd weui_cell_primary">
      <textarea class="weui_textarea" placeholder="请输入详细地点描述" rows="1" name="mwhere"></textarea>
...
<div class="weui_cells weui_cells_form">
  <div class="weui_cell">
    <div class="weui_cell_bd weui_cell_primary">
      <textarea class="weui_textarea" placeholder="请输入详细描述" rows="3" name="content"></textarea>
      <div class="weui_textarea_counter"></div>
    </div>
  </div>
</div>
<div class="weui_cells_title">联系方式</div>	
 <div class="weui_cells weui_cells_form">
  <div class="weui_cell">
    ...
    <div class="weui_cell_bd weui_cell_primary">
      <input class="weui_input" type="number" name="qq" id="qq" placeholder="请输入QQ">
    </div>
  </div>
    <div class="weui_cell">
    <div class="weui_cell_hd"><label class="weui_label">手机号码</label></div>
    <div class="weui_cell_bd weui_cell_primary">
      <input class="weui_input" type="number" name="mobile" id="mobile" placeholder="请输入手机号码">
    </div>
  </div>
