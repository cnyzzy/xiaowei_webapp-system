...
<body>
	...
	<div id="header" class="head">
		<div class="wrap">
			...
			<div class="title">
				<span class="title_d"><p>提交<?php if(!empty($Array)) { ?>成功<?php } else { ?>失败<?php } ?>:失物招领</p></span>
				<div class="clear"></div>
			</div>
  ...
  <div class="weui_text_area">
    ...
    <p class="weui_msg_desc"><?php if(!empty($Array)) { ?>您提交的内容需要经过审核才能显示，在审核通过之前依旧可以进行编辑<?php } else { ?>未提交至数据库<?php } ?></p>
  </div>
  <div class="weui_opr_area">
    <p class="weui_btn_area">
      <a href="<?php echo $arrInfo['url'];?>/swzl/my" class="weui_btn weui_btn_primary">确定</a>
      <a href="<?php echo $arrInfo['url'];?>/swzl" class="weui_btn weui_btn_default">首页</a>
    </p>
  </div>
