...
.weui-media-box__title {
    ...
    <body ontouchstart>
      ...
      <a class="weui-navbar__item<?php if($NoticeW=='2') { ?> weui-bar__item--on<?php } ?>" href="#tab3">
         校友活动
        </a>
      </div>
      ...
      <div class="weui-msg__text-area">
        ...
        <p class="weui-msg__desc">我们正在准备更多精彩活动</p>
      </div> </div>
             <?php } ?>
        </div> 
      ...
      <div class="weui-msg__text-area">
        ...
        <p class="weui-msg__desc">我们正在准备更多精彩活动</p>
             ...
             <?php } ?>
		      ...
		      <div id="tab3" class="weui-tab__bd-item<?php if($NoticeW=='3') { ?> weui-tab__bd-item--active<?php } ?>">
         	  <?php if(isset($NoticeArray3)) { ?>	 
		    <div class="weui-panel">
        <div class="weui-panel__hd">内容</div>
		  <?php foreach((array)$NoticeArray1 as $key=>$loopChild) {?>
