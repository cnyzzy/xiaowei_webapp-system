...
<head>
	...
	<link href="<?php echo $arrInfo['url'];?>/app/Z60Love/admin/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">
...
<?php include template('header'); ?>
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a>APP</a></li>
                <li class="am-active">编辑-校庆祝福管理</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 编辑祝福
                    </div>
                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form id="formid"  name= "myform" method = 'post'  action = '<?php echo $arrInfo['url'];?>/admin/Z60Love/do' onsubmit="return zform(this)" class="am-form am-form-horizontal">
  ...
  <option value="1"<?php if($Array['stype']=='1') { ?>selected="selected"<?php } ?>>学生</option>
    <option value="2"<?php if($Array['stype']=='2') { ?>selected="selected"<?php } ?>>教职工</option>
	  <option value="3"<?php if($Array['stype']=='3') { ?>selected="selected"<?php } ?>>访客</option>
    <option value="4"<?php if($Array['stype']=='4') { ?>selected="selected"<?php } ?>>校友</option>
	  <option value="5"<?php if($Array['stype']=='5') { ?>selected="selected"<?php } ?>>职工</option>
    <option value="6"<?php if($Array['stype']=='6') { ?>selected="selected"<?php } ?>>家长</option>
</select>
                                    </div>
                                </div>   
								<div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="name" placeholder="" value="<?php echo $Array['name'];?>">
                                    </div>
                                </div> 
											<div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">昵称 </label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="nickname" placeholder="" value="<?php echo $Array['nickname'];?>">
                                    </div>
                                </div>
										<div class="am-form-group">
...
<input type="text" name="content" id="editor1" value="" style="display:none">
                           ...
                           <div class="am-u-sm-9">
										...
										<div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">行政班</label>
                                    <div class="am-u-sm-9">
 ...
 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
									<input type="text" name="where" placeholder="" value="<?php echo $Array['where'];?>">
                                        <small></small>
                                    </div>
                                </div>
    ...
    <script src="<?php echo $arrInfo['url'];?>/system/admin/model/assets/js/app.js"></script>
	    <script type="text/javascript" src="<?php echo $arrInfo['url'];?>/app/Z60Love/admin/third-party/jquery.min.js"></script>
    <script type="text/javascript" src="<?php echo $arrInfo['url'];?>/app/Z60Love/admin/third-party/template.min.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo $arrInfo['url'];?>/app/Z60Love/admin/umeditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo $arrInfo['url'];?>/app/Z60Love/admin/umeditor.min.js"></script>
    <script type="text/javascript" src="<?php echo $arrInfo['url'];?>/app/Z60Love/admin/lang/zh-cn/zh-cn.js"></script>
