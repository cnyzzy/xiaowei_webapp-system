...
<html lang="en">
 ...
 <div class="weui_msg">
  ...
  <div class="weui_text_area">
    <h2 class="weui_msg_title">欢迎报名社团</h2>
    <p class="weui_msg_desc">小薇工作室技术支持</p><br>
          ...
          <a class="weui_cell" href="javascript:;">
                <div class="weui_cell_bd weui_cell_primary">
                    <div class="weui-row weui-no-gutter">
                        ...
                        <div class="weui-col-80"><?php echo $_SESSION['zid']['name'];?></div>
			  ...
			  <?php if($type=='1') { ?>
                ...
                <div class="weui_cell_bd weui_cell_primary">
                    <div class="weui-row weui-no-gutter">
                        <div class="label weui-col-20">班级:</div>
...
<?php } ?>
	  ...
	  <?php if($type!='3') { ?><BR><div class="weui_opr_area"><p class="weui_msg_desc">您可以进行以下操作</p>  </div>
  </div>
  <div class="weui_opr_area">
    <p class="weui_btn_area">
	<?php if($type=='1') { ?> <?php if($nianji<=4) { ?><a href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/bm" class="weui_btn weui_btn_warn" onClick='return wait();'>报名社团</a><?php } ?><?php } ?>
      <a href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/jl" class="weui_btn weui_btn_primary" onClick='return wait();'>查看报名记录</a>
    </p>
  </div><?php } ?>
