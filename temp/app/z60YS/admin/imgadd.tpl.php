...
<?php include template('header'); ?>
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a>APP</a></li>
                <li class="am-active">新建-校庆相册管理</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 相册
                    </div>
                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
							...
							<input type="hidden" name="do"  value="imgadd">
  ...
  <option value="3">校园风光</option>
    <option value="4">光影回忆</option>
</select>
    ...
    <i class="am-icon-cloud-upload"></i> 添加封面小图片</button></a>
										...
										<div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">图片内容</label>
                                    <div class="am-u-sm-9">
									 <textarea class="" rows="6" id="user-intro" placeholder="一行一个地址" name="content"></textarea>
                                    </div>
                                </div>
 <div class="am-form-group">
		...
		$.ajax({
		   ...
		   success: function(data){
			 if (0 == data.status) {
				...
				alert(data.content);
		$("#img1").attr("src","<?php echo $arrInfo['url'];?>/system/data/app/z60ys/"+data.url+"?"+Math.random());
		$("#smallimg").attr("value","<?php echo $arrInfo['url'];?>/system/data/app/z60ys/"+data.url);
				return false;
			 }
		   }, 
