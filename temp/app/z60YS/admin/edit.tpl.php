...
<?php include template('header'); ?>
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a>APP</a></li>
                <li class="am-active">编辑-校庆文章管理</li>
            </ol>
  ...
  <option value="1"<?php if($Array['groupid']=='1') { ?>selected="selected"<?php } ?>>学校简介</option>
    <option value="2"<?php if($Array['groupid']=='2') { ?>selected="selected"<?php } ?>>发展历程</option>
...
<input type="text" name="content" id="editor1" value="" style="display:none">
 ...
 <div class="am-form-group">
    ...
    <script type="text/javascript" charset="utf-8" src="<?php echo $arrInfo['url'];?>/app/Z60ys/admin/umeditor.min.js"></script>
