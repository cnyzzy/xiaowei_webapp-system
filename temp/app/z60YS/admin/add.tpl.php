...
<?php include template('header'); ?>
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a>APP</a></li>
                <li class="am-active">新建-校庆文章管理</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 文章消息
                    </div>
 ...
 <div class="am-form-group">
    ...
    <script type="text/javascript" src="<?php echo $arrInfo['url'];?>/app/Z60ys/admin/third-party/jquery.min.js"></script>
    <script type="text/javascript" src="<?php echo $arrInfo['url'];?>/app/Z60ys/admin/third-party/template.min.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo $arrInfo['url'];?>/app/Z60ys/admin/umeditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo $arrInfo['url'];?>/app/Z60ys/admin/umeditor.js"></script>
    <script type="text/javascript" src="<?php echo $arrInfo['url'];?>/app/Z60ys/admin/lang/zh-cn/zh-cn.js"></script>
