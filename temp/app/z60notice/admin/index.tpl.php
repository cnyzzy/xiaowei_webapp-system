...
$.ajax({
		type:"POST",
		url:"<?php echo $arrInfo['url'];?>/admin/Z60Notice/do",
...
function isokok(id,isok){
 if(confirm("确定要修改公告的显示状态么？")){
    $.post('<?php echo $arrInfo['url'];?>/admin/Z60Notice/do',{'do':'isopen','id':id,'isok':isok},function(rs){
        if(rs==1){
            window.location.reload(true);
        }
    })}
...
function add(){
 if(confirm("请谨慎操作")){
           window.open('<?php echo $arrInfo['url'];?>/admin/Z60Notice/add/');
        }
    }
function edit(id){
 if(confirm("请谨慎操作")){
           window.open('<?php echo $arrInfo['url'];?>/admin/Z60Notice/edit/'+id);
        }
    }
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a>APP管理</a></li>
                <li class="am-active">校庆公告管理</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 校庆公告管理
                    </div>
                    ...
                    <div class="am-g">
                        <div class="am-u-sm-12">
						  <div class="am-btn-toolbar">
                               ...
                               <a href="<?php echo $arrInfo['url'];?>/admin/Z60Notice/add"> <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新建公告</button></a>
                                </div>
                            </div>
                            <form class="am-form">
                                <table class="am-table am-table-striped am-table-hover table-main">
									...
									<?php foreach((array)$Array as $key=>$loopChild) {?>
                                        <tr>                                          
                                            ...
                                            <td class="am-hide-sm-only"> <?php if($loopChild['groupid']=='1') { ?>平台公告<?php } ?><?php if($loopChild['groupid']=='2') { ?>微信推送<?php } ?><?php if($loopChild['groupid']=='3') { ?>学校通知<?php } ?><?php if($loopChild['groupid']=='4') { ?>活动相关<?php } ?></td>
