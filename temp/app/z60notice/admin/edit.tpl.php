...
<?php include template('header'); ?>
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a>APP</a></li>
                <li class="am-active">编辑-校庆公告管理</li>
            </ol>
  ...
  <option value="1"<?php if($Array['groupid']=='1') { ?>selected="selected"<?php } ?>>公告信息</option>
    <option value="2"<?php if($Array['groupid']=='2') { ?>selected="selected"<?php } ?>>活动预告</option>
	  <option value="3"<?php if($Array['groupid']=='3') { ?>selected="selected"<?php } ?>>筹备动态</option>
...
<input type="text" name="content" id="editor1" value="" style="display:none">
 ...
 <div class="am-form-group">
    ...
    <script type="text/javascript" charset="utf-8" src="<?php echo $arrInfo['url'];?>/app/Z60Notice/admin/umeditor.min.js"></script>
