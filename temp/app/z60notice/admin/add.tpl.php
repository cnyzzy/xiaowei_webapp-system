...
<head>
    ...
    <link href="<?php echo $arrInfo['url'];?>/app/Z60Notice/admin/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">
...
<?php include template('header'); ?>
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a>APP</a></li>
                <li class="am-active">新建-校庆公告管理</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 公告消息
                    </div>
                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form id="formid"  name= "myform" method = 'post'  action = '<?php echo $arrInfo['url'];?>/admin/Z60Notice/do' onsubmit="return zform(this)" class="am-form am-form-horizontal">
  ...
  <option value="1">公告信息</option>
    <option value="2">活动预告</option>
	  <option value="3">筹备动态</option>
</select>
								...
								<div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="2" id="user-intro" placeholder="简介" name="dcontent"></textarea>
                                    </div>
                                </div>
										<div class="am-form-group">
    ...
    <p></p>
</script><input type="text" name="content" id="editor1" value="" style="display:none">
                                    </div>
                                </div>
 <div class="am-form-group">
                                    <label for="user-phone" class="am-u-sm-3 am-form-label">作者 </label>
                                    <div class="am-u-sm-9">
									<input type="text" name="editor" placeholder="作者" value="">
                                   ...
                                   <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="tpl-switch">
                                            <input type="checkbox" name="istop" class="ios-switch bigswitch tpl-switch-btn"/>
                                            <div class="tpl-switch-btn-view">
                                                <div>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript" src="<?php echo $arrInfo['url'];?>/app/Z60Notice/admin/third-party/jquery.min.js"></script>
    <script type="text/javascript" src="<?php echo $arrInfo['url'];?>/app/Z60Notice/admin/third-party/template.min.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo $arrInfo['url'];?>/app/Z60Notice/admin/umeditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo $arrInfo['url'];?>/app/Z60Notice/admin/umeditor.js"></script>
    <script type="text/javascript" src="<?php echo $arrInfo['url'];?>/app/Z60Notice/admin/lang/zh-cn/zh-cn.js"></script>
