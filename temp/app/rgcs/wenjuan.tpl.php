...
<body>
    ...
    <?php if($again==1) { ?>
     <div id="divLoadAnswer" style="background:#fffaea;padding:15px 10px;">
         <b style="color:red;">提示：</b>再次提交会覆盖上次的结果   <a href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/result">查看上次结果</a>
     </div>
    ...
    <div id="divContent">
        <div id="divDesc" class="formfield">
            <span class="description">
                共144题，每题选择不分对错，请选择您最倾向的。测试时间45分钟。</span>
        </div>
        ...
        <div id="divQuestion">
            <fieldset class='fieldset' style='' maxtime='2700' id='fieldset1' ><div class='cutfield' id='divCut1' qtopic='1' topic='c1'>
