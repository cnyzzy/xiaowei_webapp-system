...
<section class="col_2"><img src="<?php echo $arrInfo['url'];?>/app/<?php echo $AppName;?>/model/assets/images/profile.png"  /></section>
 <section class="col_3">无数据</section>
  <section class="col_4">0步</section>
	...
	<a href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/hdqmy/<?php echo $row['number'];?>">
...
<section class="col_2"><img src="<?php echo $row['userimg'];?>"  /></section>
 <section class="col_3"><?php echo $row['nickname'];?></section>
...
<div style="float:left;"><a  href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/hdqlist/<?php ECHO(date('Y-m-d',(strtotime($data) - 3600*24)))?>" title="前日">前一天</a> </div>
<div style="float:right;"><a  href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/hdqlist/<?php ECHO(date('Y-m-d',(strtotime($data) + 3600*24)))?>" title="后日">后一天</a></div>
</div>
  <a id="play_game" href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/hdqlist/all" title="总榜">总榜</a> </section>
<?php } else { ?>

	  <a id="play_game" href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/hdqlist" title="今日榜">今日榜单</a> </section>
<?php } ?>

<a id="return_back" href="<?php echo $arrInfo['url'];?>/<?php echo $AppName;?>/hdq/" title="返回">返回</a>
