...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $arrInfo['url'];?>/app/<?php echo $AppName;?>/model/fonts/demo.css">
    ...
    <div class="main">
        ...
        <ul class="icon_lists clear">
                ...
                <i class="icon iconfont">&#xe608;</i>
                    <div class="name">年份切换向左</div>
                    <div class="code">&amp;#xe608;</div>
                    <div class="fontclass">.title-left</div>
                </li>
                ...
                <li>
                <i class="icon iconfont">&#xe60a;</i>
                    <div class="name">文件夹3</div>
                    <div class="code">&amp;#xe60a;</div>
                    <div class="fontclass">.wenjianjia3</div>
                </li>
                ...
                <li>
                <i class="icon iconfont">&#xe61e;</i>
                    <div class="name">订单合同</div>
                    <div class="code">&amp;#xe61e;</div>
                    <div class="fontclass">.dingdanhetong</div>
                </li>
                ...
                <i class="icon iconfont">&#xe61f;</i>
                    ...
                    <div class="code">&amp;#xe61f;</div>
                    <div class="fontclass">.daiban</div>
                </li>
                ...
                <i class="icon iconfont">&#xe635;</i>
                    ...
                    <div class="code">&amp;#xe635;</div>
                    <div class="fontclass">.xiao21</div>
                </li>
                ...
                <li>
                <i class="icon iconfont">&#xe643;</i>
                    <div class="name">筛选_jammy</div>
                    <div class="code">&amp;#xe643;</div>
                    <div class="fontclass">.45354354</div>
                </li>
                ...
                <i class="icon iconfont">&#xe646;</i>
                    ...
                    <div class="code">&amp;#xe646;</div>
                    <div class="fontclass">.jixiao</div>
                </li>
                ...
                <i class="icon iconfont">&#xe62b;</i>
                    ...
                    <div class="code">&amp;#xe62b;</div>
                    <div class="fontclass">.5</div>
                </li>
            
                <li>
                <i class="icon iconfont">&#xe62c;</i>
                    <div class="name">icon-确认</div>
                    <div class="code">&amp;#xe62c;</div>
                    <div class="fontclass">.iconqueren</div>
                </li>
            
                <li>
                <i class="icon iconfont">&#xe637;</i>
                    <div class="name">导出3</div>
                    <div class="code">&amp;#xe637;</div>
                    <div class="fontclass">.daochu3</div>
                </li>
                ...
                <i class="icon iconfont">&#xe606;</i>
                    ...
                    <div class="code">&amp;#xe606;</div>
                    <div class="fontclass">.xiangshang01</div>
                </li>
                ...
                <li>
                <i class="icon iconfont">&#xe623;</i>
                    <div class="name">竞拍单据</div>
                    <div class="code">&amp;#xe623;</div>
                    <div class="fontclass">.jingpaidanju</div>
                </li>
                ...
                <i class="icon iconfont">&#xe649;</i>
                    <div class="name">待收货</div>
                    <div class="code">&amp;#xe649;</div>
                    <div class="fontclass">.daishouhuo1</div>
                </li>
                ...
                <li>
                <i class="icon iconfont">&#xe624;</i>
                    <div class="name">招标</div>
                    <div class="code">&amp;#xe624;</div>
                    <div class="fontclass">.zhaobiao</div>
                </li>
                ...
                <i class="icon iconfont">&#xe64a;</i>
                    ...
                    <div class="code">&amp;#xe64a;</div>
                    <div class="fontclass">.richeng</div>
                </li>
                ...
                <i class="icon iconfont">&#xe604;</i>
                    ...
                    <div class="code">&amp;#xe604;</div>
                    <div class="fontclass">.zuidahua</div>
                </li>
            
                <li>
                <i class="icon iconfont">&#xe621;</i>
                    <div class="name">收到询价</div>
                    <div class="code">&amp;#xe621;</div>
                    <div class="fontclass">.shoudaoxunjia</div>
                </li>
                ...
                <li>
                <i class="icon iconfont">&#xe62f;</i>
                    <div class="name">品牌授权</div>
                    <div class="code">&amp;#xe62f;</div>
                    <div class="fontclass">.pinpaishouquan</div>
                </li>
            
                <li>
                <i class="icon iconfont">&#xe625;</i>
                    <div class="name">询价</div>
                    <div class="code">&amp;#xe625;</div>
                    <div class="fontclass">.xunjia</div>
                </li>
            
                <li>
                <i class="icon iconfont">&#xe63c;</i>
                    <div class="name">底部导航公告-未选中状态</div>
                    <div class="code">&amp;#xe63c;</div>
                ...
                <i class="icon iconfont">&#xe60b;</i>
                    ...
                    <div class="code">&amp;#xe60b;</div>
                    <div class="fontclass">.multi-line-text</div>
                </li>
                ...
                <i class="icon iconfont">&#xe601;</i>
                    ...
                    <div class="code">&amp;#xe601;</div>
                    <div class="fontclass">.soliddown</div>
                </li>
                ...
                <li>
                <i class="icon iconfont">&#xe622;</i>
                    <div class="name">新加入企业预警</div>
                    <div class="code">&amp;#xe622;</div>
                    <div class="fontclass">.xinjiaruqiyeyujing</div>
                </li>
                ...
                <i class="icon iconfont">&#xe63d;</i>
                    <div class="name">任务</div>
                    <div class="code">&amp;#xe63d;</div>
                    <div class="fontclass">.renwu1</div>
                </li>
                ...
                <i class="icon iconfont">&#xe63e;</i>
                    ...
                    <div class="code">&amp;#xe63e;</div>
                    <div class="fontclass">.me-copy</div>
                </li>
                ...
                <i class="icon iconfont">&#xe64c;</i>
                    ...
                    <div class="code">&amp;#xe64c;</div>
                    <div class="fontclass">.zhiliangjianyan</div>
                </li>
                ...
                <i class="icon iconfont">&#xe602;</i>
                    <div class="name">向下</div>
                    <div class="code">&amp;#xe602;</div>
                    <div class="fontclass">.solidup</div>
                </li>
                ...
                <i class="icon iconfont">&#xe609;</i>
                    <div class="name">年份切换向左</div>
                    <div class="code">&amp;#xe609;</div>
                    <div class="fontclass">.title-right</div>
                </li>
                ...
                <i class="icon iconfont">&#xe626;</i>
                    ...
                    <div class="code">&amp;#xe626;</div>
                    <div class="fontclass">.hetong</div>
                </li>
            
                <li>
                <i class="icon iconfont">&#xe64d;</i>
                    <div class="name">退货(1)</div>
                    <div class="code">&amp;#xe64d;</div>
                    <div class="fontclass">.tuihuo1</div>
                </li>
            
                <li>
                <i class="icon iconfont">&#xe63f;</i>
                    <div class="name">云应用</div>
                    <div class="code">&amp;#xe63f;</div>
                    <div class="fontclass">.yunyingyong</div>
                </li>
