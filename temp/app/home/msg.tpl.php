    ...
    <body>
        ...
        <article style="bottom: 54px;">
            <div class="weui_cells weui_cells_access animated fadeInRight">
              ...
              <a class="weui_cell" href="/home/msgG/<?php echo $loopChild['groupid'];?><?php if($choose=='1') { ?>/1<?php } ?>">
                <div class="weui_cell_bd weui_cell_primary"> 
                    <p><i class="iconfont">&#xe61f;</i><strong><?php echo $loopChild['num'];?></strong>个  <?php if($loopChild['msgtype']=='1') { ?>私人消息<?php } ?> <?php if($loopChild['msgtype']=='2') { ?>系统消息<?php } ?> <?php if($loopChild['msgtype']=='3') { ?>【<?php echo $loopChild['fromname'];?>】APP消息<?php } ?></p>
                </div>
                <div class="iconfont">&#xe642;</div>
              </a>
           		<?php }?>
             <?php } ?>
             <?php if($choose=='0') { ?>  <a class="weui_cell" href="/<?php echo $AppName;?>/msg/1">
                <div class="weui_cell_bd weui_cell_primary">
               ...
               <?php if($choose=='1') { ?>  <a class="weui_cell" href="/<?php echo $AppName;?>/msg">
                <div class="weui_cell_bd weui_cell_primary">
