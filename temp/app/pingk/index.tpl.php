...
<html lang="en">
    <head>
        ...
        <title>教务评课-<?php echo $arrInfo['name'];?></title>
 ...
 $.hideLoading();
	$.toast("网络故障", "forbidden");
	 ...
	 $.showLoading("完成中");
		 	$.ajax({
		type:"POST",
		url:"<?php echo $arrInfo['url'];?>/pingk/do/save",
 ...
 $.hideLoading();
	$.toast("网络故障", "forbidden");
	 ...
	 $.showLoading("提交中");
		 	$.ajax({
		type:"POST",
		url:"<?php echo $arrInfo['url'];?>/pingk/do/postjw",
		data:"jid="+classnum+"&w1="+$("#w1").val()+"&w2="+$("#w2").val()+"&w3="+$("#w3").val()+"&w4="+$("#w4").val()+"&w5="+$("#w5").val(),
		dataType: "json", 
		async:true,		
		complete:function(XMLHttpRequest, textStatus){
 ...
 $.hideLoading();
	$.toast("网络故障", "forbidden");
	 ...
	 $.showLoading();
		 	$.ajax({
		type:"POST",
		url:"<?php echo $arrInfo['url'];?>/pingk/do/readjw",
		data:"jid="+classnum,
		dataType: "json", 
		async:true,		
		complete:function(XMLHttpRequest, textStatus){
 ...
 $.hideLoading();
	$.toast("网络故障", "forbidden");
	 ...
	 $.showLoading("加载评课数据");
		 	$.ajax({
		type:"POST",
		url:"<?php echo $arrInfo['url'];?>/pingk/do/jw",
		data:"0",
		dataType: "json", 
		async:true,		
		complete:function(XMLHttpRequest, textStatus){
 ...
 $.hideLoading();
	$.toast("网络故障", "forbidden");
	 ...
	 $.showLoading();
		 	$.ajax({
		type:"POST",
		url:"<?php echo $arrInfo['url'];?>/pingk/do/loading",
		data:"0",
		dataType: "json", 
		async:true,		
		complete:function(XMLHttpRequest, textStatus){
...
$("#yzmm").focus();
    ...
    return;          
		 	...
		 	$.ajax({
		type:"POST",
		url:"<?php echo $arrInfo['url'];?>/pingk/do/login",
		data:"&yanzm="+$("#yzmm").val(),
		dataType: "json", 
		async:true,		
		complete:function(XMLHttpRequest, textStatus){
...
$("#s2").show();loadingjw();
 ...
 $.hideLoading();
	...
	$.showLoading("正在清除");
				 	$.ajax({
		type:"POST",
		url:"<?php echo $arrInfo['url'];?>/pingk/do/clean",
		dataType: "json", 
		async:true,		
		complete:function(XMLHttpRequest, textStatus){
