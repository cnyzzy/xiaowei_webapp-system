...
<?php include template('header'); ?>
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a>APP</a></li>
                <li class="am-active">编辑-公告管理</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 编辑公告
                    </div>
  ...
  <option value="1"<?php if($Array['groupid']=='1') { ?>selected="selected"<?php } ?>>平台公告</option>
    <option value="2"<?php if($Array['groupid']=='2') { ?>selected="selected"<?php } ?>>学术讲坛</option>
	  <option value="3"<?php if($Array['groupid']=='3') { ?>selected="selected"<?php } ?>>学校通知</option>
	  <option value="4"<?php if($Array['groupid']=='4') { ?>selected="selected"<?php } ?>>活动公示</option>
</select>
