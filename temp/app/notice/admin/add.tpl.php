...
<head>
    ...
    <link href="<?php echo $arrInfo['url'];?>/app/notice/admin/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">
    <script type="text/javascript" src="<?php echo $arrInfo['url'];?>/app/notice/admin/third-party/jquery.min.js"></script>
    <script type="text/javascript" src="<?php echo $arrInfo['url'];?>/app/notice/admin/third-party/template.min.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo $arrInfo['url'];?>/app/notice/admin/umeditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo $arrInfo['url'];?>/app/notice/admin/umeditor.min.js"></script>
    <script type="text/javascript" src="<?php echo $arrInfo['url'];?>/app/notice/admin/lang/zh-cn/zh-cn.js"></script>
    <style type="text/css">
        h1{
            font-family: "微软雅黑";
            font-weight: normal;
...
<?php include template('header'); ?>
                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form id="formid"  name= "myform" method = 'post'  action = '<?php echo $arrInfo['url'];?>/admin/notice/do' onsubmit="return zform(this)" class="am-form am-form-horizontal">
  ...
  <option value="1">平台公告</option>
    <option value="2">学术讲坛</option>
	  <option value="3">学校通知</option>
	  <option value="4">活动公示</option>
</select>
