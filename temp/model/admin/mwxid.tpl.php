...
if(confirm("回收站中的数据仅供审查，请谨慎操作")){
           window.open('<?php echo $arrInfo['url'];?>/admin/mwxidh');
        }
...
if(confirm("确定要修改此绑定信息的使用权限么？如果禁用，此身份和微信都被禁用")){
	$.ajax({
		type:"POST",
		url:"<?php echo $arrInfo['url'];?>/admin/dowxid",
...
function islock(id,Alock){
 if(confirm("确定要修改此绑定信息的变更权限么？")){
    $.post('<?php echo $arrInfo['url'];?>/admin/dowxid',{'do':'islock','id':id,'lock':Alock},function(rs){
        if(rs==1){
            window.location.reload(true);
        }
    })}
...
function edit(id){
           ...
           window.open('<?php echo $arrInfo['url'];?>/admin/mwxidd/'+id);
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a>绑定管理</a></li>
                <li class="am-active">绑定管理</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 绑定管理
                    </div>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo $arrInfo['url'];?>/admin/mwxidd/<?php echo $loopChild['id'];?>"><?php echo $loopChild['nickname'];?>/<?php echo $loopChild['name'];?></a></td>
