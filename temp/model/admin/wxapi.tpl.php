...
<?php include template('header'); ?>
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a>微信管理</a></li>
                <li class="am-active">公众号API配置</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span>公众号API的配置
                    </div>
                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form id="formid"  name= "myform" method = 'post'  action = 'dowxapi'  class="am-form tpl-form-line-form">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">APPID <span class="tpl-form-line-small-title">微信接口ID</span></label>
                                    <div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">AppSecret <span class="tpl-form-line-small-title">微信接口秘钥</span></label>
                                    <div class="am-u-sm-9">
								...
								<div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">ApiTOKEN <span class="tpl-form-line-small-title">微信接口TOKEN</span></label>
                                    <div class="am-u-sm-9">
