...
<head>
    ...
    <title>微信小程序绑定回收站-小薇平台管理后台</title>
...
if(confirm("确定要修改此绑定信息的使用权限么？如果禁用，此身份和微信都被禁用")){
	$.ajax({
		type:"POST",
		url:"<?php echo $arrInfo['url'];?>/admin/dowxxid",
...
function islock(id,Alock){
 if(confirm("确定要修改此绑定信息的变更权限么？")){
    $.post('<?php echo $arrInfo['url'];?>/admin/dowxxid',{'do':'islock','id':id,'lock':Alock},function(rs){
        if(rs==1){
            window.location.reload(true);
        }
    })}
...
function edit(id){
 if(confirm("请谨慎操作，极易造成绑定关系紊乱")){
           window.open('<?php echo $arrInfo['url'];?>/admin/mwxxidd/'+id);
        }
    }
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a>绑定管理</a></li>
                <li class="am-active">微信小程序绑定回收站</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 微信小程序绑定回收站
                    </div>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo $arrInfo['url'];?>/admin/mwxxidd/<?php echo $loopChild['id'];?>"><?php echo $loopChild['nickname'];?>/<?php echo $loopChild['name'];?></a></td>
