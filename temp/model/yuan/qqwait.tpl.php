...
<body>
  ...
  <div class="weui_text_area">
    <h2 class="weui_msg_title">请关注"盐城师范学院"QQ公众号</h2>
    <p class="weui_msg_desc">感谢您选择使用由小薇工作室提供的在线服务。<br>腾讯规定QQ用户必须关注校园号后才能被识别身份，当前您还没有关注。<br>如果您想继续使用，请点击下方关注我们。您也可以使用微信访问本平台。<br>感谢您的支持。</p>
  </div>
...
" class="weui_btn weui_btn_primary">我要关注</a>
