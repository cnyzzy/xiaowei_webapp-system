...
<body>
  ...
  <div class="weui_text_area">
    <h2 class="weui_msg_title">请关注"盐城师范学院"</h2>
    <p class="weui_msg_desc">感谢使用由"盐城师范学院"提供的在线查询服务，有任何疑问都可以直接联系我们。</p>
  </div>
  <div class="weui_opr_area">
    <p class="weui_btn_area">
      <a href="<?php if(!empty($URLL)) { ?><?php echo $URLL;?><?php } else { ?><?php echo $arrInfo['url'];?><?php } ?>" class="weui_btn weui_btn_primary">继续使用</a>
...
" class="weui_btn weui_btn_default">我要关注</a>
    </p>
  </div>
