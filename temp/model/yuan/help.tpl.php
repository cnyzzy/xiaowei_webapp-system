  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      <div class="am-u-sm-12 am-u-sm-centered">
        <h2>招新系统</h2>
        <p>基于php+mysql+阿里系</p>
        <p>拥有几乎全部的原始资料库，便于信息录入。</p>
        <p>进行手机号码的验证和后台整理，利于信息管理。</p>
		<p>可以Excel导出数据，利于信息再利用</p>
        <hr/>
      </div>

      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <h3>Bug 反馈</h3>
        <p>感谢对 招新系统 的关注和支持，如遇到 Bug 或者使用问题，可以通过以下途径反馈给我：</p>
        <ol>
          <li>QQ 970127005。</li>
          <li>Email cnyzzy@qq.com。</li>
        </ol>
        <p>注意事项</p>
        <p>危险权限都进行了限制。</p>
        <p>下面的几个链接是服务提供商地址，仅供陈列。</p>
        <ol>
          <li><a href="http://aliyun.com" target="_blank">阿里云</a> </li>
          <li><a href="http://alidayu.com" target="_blank">阿里大于</a> </li>
          <li><a href="http://www.cn" target="_blank">万网</a> </li>
        </ol>
      </div>
    </div>
  </div>
